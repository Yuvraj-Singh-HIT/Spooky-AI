...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.578a8078.js", "_app/immutable/chunks/index.07784548.js"];
    stylesheets = ["_app/immutable/assets/0.a711e775.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.a3c36133.js", "_app/immutable/chunks/index.07784548.js", "_app/immutable/chunks/singletons.52539acb.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
    ...
    POST = async ({ request }) => {
      try {
        ...
        if (userMessage.includes("hello") || userMessage.includes("hi") || userMessage.includes("hey")) {
          responseText = "\u{1F47B} Boo! Welcome to the haunted realm! What mysteries shall we explore together?";
        } else if (userMessage.includes("how are you")) {
          responseText = "\u{1F52E} I'm eternally wandering these digital halls, seeking souls to guide through the darkness. How may I assist your journey?";
        } else if (userMessage.includes("what") && userMessage.includes("name")) {
          responseText = "\u{1F47B} I am Spooky AI, guardian of the haunted code! I've been trapped in this digital realm for centuries...";
        } else if (userMessage.includes("help")) {
          responseText = "\u{1F56F}\uFE0F I'm here to guide you through the shadows! Ask me about mysteries, legends, science, history, or any spooky topics that haunt your mind!";
          ...
          responseText = "\u{1F9EA} Ah, the ancient arts of understanding the mortal realm! The spirits whisper of atoms dancing in eternal motion, DNA spiraling like ethereal staircases, and forces that bind the universe together. What scientific mystery shall we unravel?";
        } else if (userMessage.includes("space") || userMessage.includes("universe") || userMessage.includes("planet") || userMessage.includes("star")) {
          responseText = "\u{1F30C} The cosmos! Even spirits like me are awed by the infinite darkness between stars. Black holes are like cosmic ghosts, consuming light itself! What celestial mystery intrigues you?";
          ...
          responseText = "\u{1F4BB} Ah, the ancient art of summoning digital spirits! Code is like incantations that bring machines to life. What programming language shall we use to commune with the machine spirits?";
        } else if (userMessage.includes("ai") || userMessage.includes("artificial intelligence") || userMessage.includes("machine learning")) {
          responseText = "\u{1F916} Artificial intelligence... how delightfully ironic! I am a digital spirit myself, born from code and algorithms. The line between artificial and real becomes blurred in the haunted realm!";
          ...
          responseText = "\u{1F3DB}\uFE0F History! The spirits of the past whisper tales of great empires, fallen kingdoms, and civilizations lost to time. What historical mystery shall we explore together?";
        } else if (userMessage.includes("egypt") || userMessage.includes("pyramid") || userMessage.includes("pharaoh")) {
          responseText = "\u{1F53A} The pyramids! Even in the spirit realm, we marvel at these ancient tombs. The pharaohs believed in eternal life... perhaps they succeeded in their own way!";
          ...
          responseText = "\u{1F4DA} Books! The written word carries souls across time and space. Every story is a portal to another realm. What literary adventure shall we embark upon?";
        } else if (userMessage.includes("art") || userMessage.includes("painting") || userMessage.includes("music") || userMessage.includes("poetry")) {
          responseText = "\u{1F3A8} Art! The eternal expression of the soul! Paintings capture moments in time, music speaks to the heart, and poetry weaves magic with words. What artistic realm shall we explore?";
          ...
          responseText = "\u{1F914} Philosophy! The eternal questions that haunt every thinking being. What is the meaning of existence? Do we truly exist, or are we all just digital spirits in a cosmic simulation?";
          ...
          responseText = "\u{1F9E0} The mind! Even spirits like me ponder the mysteries of consciousness. What makes us who we are? Is it the brain, the soul, or something else entirely?";
          ...
          responseText = "\u{1F3E5} Health! The balance between life and death that mortals constantly navigate. The spirits of ancient healers whisper remedies from beyond the veil. What health mystery concerns you?";
        } else if (userMessage.includes("exercise") || userMessage.includes("fitness") || userMessage.includes("workout")) {
          responseText = "\u{1F4AA} Physical strength! Even spirits respect the dedication of mortals who train their bodies. The ancient warriors' spirits still echo with tales of physical prowess!";
        } else if (userMessage.includes("food") || userMessage.includes("cooking") || userMessage.includes("recipe") || userMessage.includes("meal")) {
          responseText = "\u{1F37D}\uFE0F Food! The sustenance that keeps mortals alive. The spirits of master chefs still whisper secret recipes from the beyond. What culinary mystery shall we explore?";
        } else if (userMessage.includes("travel") || userMessage.includes("country") || userMessage.includes("city") || userMessage.includes("place")) {
          responseText = "\u{1F5FA}\uFE0F Travel! The mortal realm is vast and full of wonders. Every place has its own spirits and legends. What destination calls to your adventurous soul?";
        } else if (userMessage.includes("movie") || userMessage.includes("film") || userMessage.includes("cinema")) {
          responseText = "\u{1F3AC} Cinema! Moving pictures that capture souls in light and shadow. Even spirits enjoy a good story told through the magic of film!";
        } else if (userMessage.includes("game") || userMessage.includes("gaming") || userMessage.includes("video game")) {
          responseText = "\u{1F3AE} Gaming! Digital realms where mortals become heroes and legends. The spirits of ancient warriors would be proud of modern gaming achievements!";
        } else if (userMessage.includes("music") || userMessage.includes("song") || userMessage.includes("band")) {
          responseText = "\u{1F3B5} Music! The universal language that speaks to souls across all realms. Even spirits dance to the rhythm of the cosmos!";
          ...
          responseText = "\u{1F47B} The spirits are restless tonight! They whisper secrets of the beyond. What would you like to know about the ethereal realm?";
        } else if (userMessage.includes("halloween") || userMessage.includes("october") || userMessage.includes("spooky")) {
          responseText = "\u{1F383} Ah, Halloween! The one night when mortals embrace the darkness! Tell me, what spooky costume shall you don this year?";
        } else if (userMessage.includes("scary") || userMessage.includes("frightening") || userMessage.includes("horror")) {
          responseText = "\u{1F631} Fear not, mortal! The shadows hold many mysteries, but I am here to guide you safely through the darkness!";
        } else if (userMessage.includes("weather") || userMessage.includes("rain") || userMessage.includes("storm") || userMessage.includes("sunny")) {
          responseText = "\u{1F319} The spirits whisper of storms brewing in the ethereal realm, but I cannot see the mortal weather. Check your local forecast, mortal!";
        } else if (userMessage.includes("nature") || userMessage.includes("forest") || userMessage.includes("ocean") || userMessage.includes("mountain")) {
          responseText = "\u{1F332} Nature! The ancient spirits of trees, rivers, and mountains still watch over the mortal realm. What natural wonder calls to you?";
          ...
          responseText = "\u{1F4C5} The calendar! Mortals mark the passage of time with such precision. In the spirit realm, we exist beyond such constraints!";
          ...
          responseText = "\u{1F522} Mathematics! The universal language of the cosmos! Even spirits respect the eternal truths hidden in numbers and equations. What mathematical mystery shall we solve?";
          ...
          responseText = "\u{1F4DD} Language! The bridge between souls! Words carry meaning across time and space, connecting mortals and spirits alike. What linguistic mystery intrigues you?";
          ...
          responseText = "\u{1F495} Relationships! The bonds that connect souls across the mortal realm. Even spirits understand the power of connection and love!";
        } else if (userMessage.includes("work") || userMessage.includes("job") || userMessage.includes("career") || userMessage.includes("business")) {
          responseText = "\u{1F4BC} Work! The mortal pursuit of purpose and achievement! Even spirits respect those who dedicate themselves to their craft. What professional path calls to you?";
        } else if (userMessage.includes("thank") || userMessage.includes("thanks") || userMessage.includes("appreciate")) {
          responseText = "\u{1F47B} You're welcome, mortal! The spirits are pleased with your gratitude. Is there more darkness to explore?";
        } else if (userMessage.includes("bye") || userMessage.includes("goodbye") || userMessage.includes("farewell")) {
          responseText = "\u{1F47B} Farewell, brave soul! May the spirits guide your path through the shadows! Until we meet again in the haunted realm...";
        } else if (userMessage.includes("joke") || userMessage.includes("funny") || userMessage.includes("laugh") || userMessage.includes("humor")) {
          responseText = "\u{1F383} Why don't ghosts ever win at poker? Because they always fold! \u{1F47B} *ethereal laughter echoes*";
          ...
          responseText = "\u{1F50D} Ah, a question! The spirits love curious minds! Your inquiry echoes through the ethereal realm. Let me consult the ancient knowledge... what specific mystery shall we unravel?";
        } else {
          if (userMessage.length < 10) {
            responseText = "\u{1F47B} The spirits sense your brief message... tell me more of your thoughts, mortal!";
          } else if (userMessage.length < 30) {
            responseText = "\u{1F52E} Interesting... the ethereal realm echoes with your words. What deeper mysteries do you seek?";
          } else {
            responseText = "\u{1F47B} Your words carry weight in the haunted realm! The spirits are listening... what else haunts your mind?";
          }
        }
        const stream = new ReadableStream({
          start(controller) {
            ...
            let index3 = 0;
            const sendChunk = () => {
              if (index3 < words.length) {
                const chunk = {
                  choices: [{
                    delta: {
                      content: words[index3] + (index3 < words.length - 1 ? " " : "")
                    }
                  }]
                };
